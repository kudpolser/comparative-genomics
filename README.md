...
Тогда число общих блоков для 5kb - 133, а повторяющихся - (156 - 133) = 23. Для 1kb общих блоков - 151, а повторяющихся - (311 - 151) = 160.
Разница в том что в общих блоках я учла и те что повторяются, а в повторящихся во втором варианте есть те, что не повторяют ни разу (в случае если они представлены по одному разу не во всех сборках).
...
Сценарий пересторийки включает 8 шагов:

![GitHub Logo](rearrangement.png)
